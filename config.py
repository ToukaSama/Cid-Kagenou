...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7319320335:AAEqwtQwohpN6EZFFfqGOb9fGE3PexBWSMo")
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "CidKagenou")
...
DB_NAME = os.environ.get("DATABASE_NAME", "CidKagenou")
